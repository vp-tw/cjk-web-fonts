...
const en: Messages = {
  ...
  catalog: {
    ...
    families: "families",
    search: "Search fonts",
    searchPlaceholder: "Official name, package, or feature",
    ...
    htmlEmbed: "HTML stylesheet",
    cssFontFamily: "CSS font family",
    copied: "Copied",
    copyCode: "Copy code",
...
const ja: Messages = {
  ...
  catalog: {
    ...
    families: "ファミリー",
    search: "フォントを検索",
    searchPlaceholder: "公式名、パッケージ、特徴",
    filters: "フォント絞り込み",
    category: "フォント種別",
    ...
    codePoints: "コードポイント",
    htmlEmbed: "HTML スタイルシート",
    cssFontFamily: "CSS フォントファミリー",
    copied: "コピー済み",
    copyCode: "コードをコピー",
...
const ko: Messages = {
  ...
  catalog: {
    ...
    families: "패밀리",
    search: "폰트 검색",
    searchPlaceholder: "공식 이름, 패키지 또는 특징",
    filters: "글꼴 필터",
    category: "글꼴 유형",
    ...
    codePoints: "코드 포인트",
    htmlEmbed: "HTML 스타일시트",
    cssFontFamily: "CSS 글꼴 패밀리",
    copied: "복사됨",
    copyCode: "코드 복사",
